function NPBSS(referenceFile,pnames)
if nargin < 2
    fprintf('-----------------------------------------\n');
    fprintf('NPBSS needs at least 2 input arguments\n');
    fprintf('Example: NPBSS(''EcoliGenome.fa'', ''-dep 5'')\n');
    fprintf('---Usage:\n');
...
if samFlag
    writeToSamFile(samFormat, qv, [fileName,'.npbss_simulated_CLR.sam'], genomeName, length(genome));
end
end